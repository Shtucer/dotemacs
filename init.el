...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (emacsql-psql emacsql-mysql emacsc windresize web-mode solarized-theme slim-mode sass-mode rainbow-mode rainbow-delimiters py-autopep8 powerline maxframe linum-relative groovy-mode gradle-mode go-mode go-autocomplete flymake-python-pyflakes flymake-php flymake-haskell-multi flylisp flycheck fic-mode evil-surround evil-smartparens evil-paredit evil-org evil-numbers evil-nerd-commenter evil-matchit evil-lisp-state ensime emmet-mode elpy ecb django-snippets django-mode column-marker auto-complete-clang-async auto-complete-clang ac-slime ac-php ac-js2 ac-html-bootstrap ac-html ac-haskell-process ac-clang abyss-theme)))
